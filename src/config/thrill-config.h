/* src/config/thrill-config.h.  Generated from thrill-config.h.in by configure.  */
/* src/config/thrill-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef THRILL_CONFIG_H

#define THRILL_CONFIG_H
...
#define PACKAGE_BUGREPORT "http://bit.thrills"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Thrill Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Thrill Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "thrill"
