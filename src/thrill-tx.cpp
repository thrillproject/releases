...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Thrill Core thrill-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  thrill-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded thrill transaction") + "\n" +
                               "  thrill-tx [options] -create [commands]   " + _("Create hex-encoded thrill transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded thrill transaction
