...
/** Utility functions used by the THRILL Qt UI.
 */
namespace GUIUtil
{
...
// Render THRILL addresses in monospace font
...
// Parse "thrill:" URI into recipient object, return true on successful parsing
