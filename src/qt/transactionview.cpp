                                                    ...
                                                    transactionView(0)
{
    ...
    dateWidget->setStyleSheet(" QComboBox {border:1px solid #00a2e8; color:#00a2e8; border-radius:10px; padding-left:10px; padding-top:5px; padding-right:10px; padding-bottom:5px;}");
#ifdef Q_OS_MAC
    ...
    typeWidget->setStyleSheet(" QComboBox {border:1px solid #00a2e8; color:#00a2e8; border-radius:10px; padding-left:10px; padding-top:5px; padding-right:10px; padding-bottom:5px;}");
#ifdef Q_OS_MAC
    ...
    addressWidget->setStyleSheet(" QLineEdit {border:1px solid #000; color:#000; border-radius:10px; padding-left:10px; padding-top:5px; padding-right:10px; padding-bottom:5px;}");
    ...
    amountWidget->setStyleSheet(" QLineEdit {border:1px solid #000; color:#000; border-radius:10px; padding-left:10px; padding-top:5px; padding-right:10px; padding-bottom:5px;}");
#if QT_VERSION >= 0x040700
