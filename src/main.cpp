...
#if defined(NDEBUG)
#error "Thrill cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Thrill Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if( nHeight >= 1 && nHeight <= 300 ) {
	        nSubsidy = 1 * COIN;
    } else if (nHeight >= 301 && nHeight < 1400) {
        nSubsidy = 1 * COIN;
    } else if (nHeight >= 1401 && nHeight < 4100) {
        nSubsidy = 1 * COIN;
    } else if (nHeight >= 4101 && nHeight < 8600) {
        nSubsidy = 1.5 * COIN;
    } else if (nHeight >= 8601 && nHeight < 20000) {
        nSubsidy = 2 * COIN;
    } else if (nHeight >= 20001 && nHeight < 50000) {
        nSubsidy = 3 * COIN;
    } else if (nHeight >= 50001 && nHeight < 100000) {
        nSubsidy = 5 * COIN;
    } else if (nHeight >= 100001 && nHeight < 150000) {
        nSubsidy = 7 * COIN;
    } else if (nHeight >= 150001 && nHeight < 250000) {
        nSubsidy = 8 * COIN;
    } else if (nHeight >= 250001 && nHeight < 350000) {
        nSubsidy = 7 * COIN;
    } else if (nHeight >= 350001 && nHeight < 500000) {
        nSubsidy = 6 * COIN;
    } else if (nHeight >= 500001 && nHeight < 700000) {
        nSubsidy = 5.5 * COIN;
