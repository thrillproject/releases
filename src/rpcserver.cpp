...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* THRILL features */
        {"thrill", "masternode", &masternode, true, true, false},
        {"thrill", "masternodelist", &masternodelist, true, true, false},
        {"thrill", "mnbudget", &mnbudget, true, true, false},
        {"thrill", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"thrill", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"thrill", "mnsync", &mnsync, true, true, false},
        {"thrill", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"thrill", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use thrilld, or the -server option to thrill-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> thrill-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9731/\n";
}
