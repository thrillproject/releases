...
RESOURCES += src/qt/thrill.qrc src/qt/thrill_locale.qrc

TRANSLATIONS += src/qt/locale/thrill_bg.ts \
                src/qt/locale/thrill_de.ts \
                src/qt/locale/thrill_en.ts \
                src/qt/locale/thrill_es.ts \
                src/qt/locale/thrill_fi.ts \
                src/qt/locale/thrill_fr.ts \
                src/qt/locale/thrill_it.ts \
                src/qt/locale/thrill_ja.ts \
                src/qt/locale/thrill_pl.ts \
                src/qt/locale/thrill_pt.ts \
                src/qt/locale/thrill_ru.ts \
                src/qt/locale/thrill_sk.ts \
                src/qt/locale/thrill_sv.ts \
                src/qt/locale/thrill_vi.ts \
                src/qt/locale/thrill_zh_CN.ts \
                src/qt/locale/thrill_zh_TW.ts
